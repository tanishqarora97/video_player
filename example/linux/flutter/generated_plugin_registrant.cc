...
#include <universal_videoplayer/flutter_meedu_videoplayer_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) universal_videoplayer_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "FlutterMeeduVideoplayerPlugin");
  flutter_meedu_videoplayer_plugin_register_with_registrar(universal_videoplayer_registrar);
